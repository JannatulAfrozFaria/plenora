    ...
    return (
        <div>
            ...
            <div className="carousel-item relative w-full h-[50vh] md:h-[90vh] bg-no-repeat bg-cover"
                ...
                <div>
                    <h1 className=" absolute p-12 md:p-24 top-10 md:top-20 txt-4xl md:text-9xl font-black text-white">Our <br /> <span className='text-theme'>Studio</span></h1>
                </div>
            </div>
            ...
            <div className='w-5/6 mx-auto grid grid-cols-1 gap-6 md:gap-16 mb-12'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-6 gap-6 items-center'>
                    <div className='col-span-1'>
                        <h1 className="text-gray text-xl md:text-7xl font-bold">20<span className='text-theme text-4xl md:text-9xl '>09</span> </h1>
                    </div>
                    <div className='col-span-4 w-5/6 ml-0 md:ml-20 text-justify'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-6 gap-6 md:gap-12 items-center'>
                    ...
                    <div className='col-span-1'>
                        <h1 className="text-gray text-xl md:text-7xl font-bold">20<span className='text-theme text-4xl md:text-9xl '>14</span> </h1>
                    </div>
                    <div className='col-span-4'>
                        <h1 className="text-gray w-5/6 ml-0 md:ml-20 text-justify">Hardly a year old, Plenora receives a Lieutenant Governor of British Columbia Award of Merit for a Mayne Island retreat, completes Wolfe House, and wins Western Living Magazine’s inaugural Architecture Designer of the Year.</h1>
                    </div>
                ...
                <div className='col-span-4'>
                    ...
                    <div className='col-span-1'>
                        <h1 className="text-gray text-xl md:text-7xl font-bold">20<span className='text-theme text-4xl md:text-9xl '>22</span> </h1>
                    </div>
                </div>
            </div>
